...
@interface CPBRPGViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,MJNIndexViewDataSource>
...
@property (weak, nonatomic) IBOutlet CPBRPGMatchingSelectButton *treatBtn;
