...
- (IBAction)matchingBtnClick:(id)sender {
    ...
    NSDictionary *params=[[NSDictionary alloc]initWithObjectsAndKeys: @"遛狗",@"type",@(NO),@"transfer",establish,@"establish",estabPoint,@"estabPoint",estabPoint,@"destPoint",establish,@"destination",@"AA制",@"pay", nil];
