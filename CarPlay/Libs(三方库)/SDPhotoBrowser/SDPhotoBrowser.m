...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    UIView *sourceView = self.sourceImagesContainerView.subviews[currentIndex >= [self.sourceImagesContainerView.subviews count] ? currentIndex % [self.sourceImagesContainerView.subviews count] : currentIndex];
...
- (void)showFirstImage
{
    UIView *sourceView = self.sourceImagesContainerView.subviews[self.currentImageIndex >=[self.sourceImagesContainerView.subviews count] ? self.currentImageIndex % [self.sourceImagesContainerView.subviews count] : self.currentImageIndex];
