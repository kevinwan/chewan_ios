...
#import "CAAnimation+ZY.h"
#import <QuartzCore/QuartzCore.h>
#import "UIView+Extension.h"

@implementation CAAnimation (ZY)
/**
 *  breathing forever
 *
...
+(CABasicAnimation *)rotation:(float)dur degree:(float)degree direction:(ZYAxis)axis repeatCount:(int)repeatCount
{
    ...
    NSArray *axisArr = @[ZYAnimationRotationXKey, ZYAnimationRotationYKey, ZYAnimationRotationZKey];
...
{
    CABasicAnimation *animation=[CABasicAnimation animationWithKeyPath:ZYAnimationScaleKey];
