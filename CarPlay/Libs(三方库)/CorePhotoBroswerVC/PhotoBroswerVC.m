...
+(void)show:(UIViewController *)handleVC userId:(NSString *)userId type:(PhotoBroswerVCType)type index:(NSUInteger)index photoModelBlock:(NSArray *(^)())photoModelBlock{
