...
- (void)viewDidLoad {
    [super viewDidLoad];
    dataArray=[[NSArray alloc]initWithObjects:@"发表活动指南",@"车主认证申请",@"活动规则",@"活动发起权限",@"车玩举报指南",@"车玩举报入口", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *titleStr=[[NSString alloc]initWithFormat:@"%ld.%@",indexPath.row+1,[dataArray objectAtIndex:indexPath.row]];
