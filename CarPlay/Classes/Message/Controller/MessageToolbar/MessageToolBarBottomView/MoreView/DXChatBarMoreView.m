...
- (void)setupSubviewsForType:(ChatMoreType)type
{
    ...
    [photoLabel setFrame:CGRectMake(_photoButton.left, _photoButton.bottom+5, CHAT_BUTTON_SIZE, 12)];
    ...
    [takePicLabel setFrame:CGRectMake(_takePicButton.left, _takePicButton.bottom+5, CHAT_BUTTON_SIZE, 12)];
    ...
    [locationLabel setFrame:CGRectMake(_locationButton.left, _locationButton.bottom+5, CHAT_BUTTON_SIZE, 12)];
