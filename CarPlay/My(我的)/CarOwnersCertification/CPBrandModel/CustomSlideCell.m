...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        self.carNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(12, 0, ZYScreenWidth - 120-12-5, [CustomSlideCell standardHeight])];
        ...
        UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 44.5, ZYScreenWidth, .5)];
